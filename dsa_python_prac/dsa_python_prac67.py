...
Figure: Divide List Into Two Parts
Idea Emoji
...
Recursively Divide Subparts
Figure: Recursively Divide Subparts
3. Merge the individual elements in a sorted manner.

Here, the conquer and combine steps go side by side.

Sort and then Combine Individual Elements
Figure: Sort and then Combine Individual Elements
